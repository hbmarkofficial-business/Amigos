...
const Contact = () => {
  return (
    <>
      <Helmet>
        <title>Kontakt & Termin | Barber Shop & Friseur Aachen</title>
        <meta 
          name="description" 
          content="Kontaktieren Sie Barber Shop & Friseur in Aachen. Vereinbaren Sie Ihren Termin über unseren Chatbot oder rufen Sie uns an. Mo-Sa 09-20 Uhr." 
        />
        ...
        <script type="application/ld+json">
          {JSON.stringify({
            ...
            "name": "Barber Shop & Friseur Aachen",
            ...
            "sameAs": [
              "https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d80620.45584515663!2d6.057506539062488!3d50.84247589087447!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x47c0996842671873%3A0xe503f2e89b1b12f1!2sAmigos!5e0!3m2!1sde!2sde!4v1770382512915!5m2!1sde!2sde",
              ...
              <AnimateOnScroll animation="slide-right" className="order-2 lg:order-2">
                <div className="space-y-8">
                  ...
                  <div className="space-y-6">
                    ...
                    <div className="flex items-start gap-4">
                      ...
                      <div>
                        ...
                        <a 
                          href="mailto:info@barbershop-friseur.de" 
                          className="text-muted-foreground hover:text-primary transition-colors"
                        >
                          info@barbershop-friseur.de
                        </a>
                      </div>
                    </div>
                  ...
                  <div className="aspect-video rounded-sm overflow-hidden border border-border mt-8">
                    <iframe
                      src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d80620.45584515663!2d6.057506539062488!3d50.84247589087447!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x47c0996842671873%3A0xe503f2e89b1b12f1!2sAmigos!5e0!3m2!1sde!2sde!4v1770382512915!5m2!1sde!2sde"
                      width="100%"
                      height="100%"
                      ...
                      title="Standort Barber Shop & Friseur Aachen"
                    />
                  </div>
                </div>
              </AnimateOnScroll>
